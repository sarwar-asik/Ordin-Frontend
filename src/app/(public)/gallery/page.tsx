        ...
        <div className="flex justify-center items-center text-black">
          ...
          <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
            <div role="main" className="flex flex-col items-center justify-center">
              <h1 className="text-4xl font-semibold leading-9 text-center">Our Gallery</h1>
              <p className="text-base leading-normal text-center text-slate-500 mt-4 lg:w-1/2 md:w-10/12 w-11/12">If you are looking for random paragraphs, you ve come to the right place. When a random word or a random sentence isn t quite enough</p>
            </div>
